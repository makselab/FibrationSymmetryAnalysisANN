...
def fibration_linear(input_colors, threshold, module):
    ...
    clusters = tensor(fcluster(Z, t=dim_out-threshold, criterion='maxclust'),dtype=int64)-1
...
def fibration_conv2d(input_colors, threshold, module):
    ...
    Z = linkage(distance_condensed, method='average')
    clusters = tensor(fcluster(Z, t=out_n-threshold, criterion='maxclust'),dtype=int64)-1
...
def fibration_lstm(input_colors, threshold, module):
    ...
    for layer_idx in range(1):
        ...
        for t in range(T):
            ...
            Z = linkage(distance_condensed, method='average')
            gates_clusters = tensor(fcluster(Z, t=dim_h-threshold, criterion='maxclust'))
            ...
            # gates_clusters = tensor(gates_clusters)
...
def fibration_flatten(input_colors, threshold, module, times=54):
    ...
    # return repeat_interleave(input_colors[0],times) #Check